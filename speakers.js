...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadSpeaker(speaker) {
        ...
        // Create image (wrapped to support optional hover-swap easter egg)
        const imgWrap = document.createElement('div');
        imgWrap.className = 'speaker-image-wrap';
        ...
        if (speaker.hoverImage) {
            const hoverImg = document.createElement('img');
            hoverImg.src = `speakers/${speaker.folder}/${speaker.hoverImage}`;
            hoverImg.alt = '';
            hoverImg.className = 'speaker-image speaker-image-hover';
        ...
        // Optional organization line under name
        let organization = null;
        if (speaker.organization) {
            organization = document.createElement('p');
            organization.className = 'speaker-organization';
        ...
        // Assemble card
        speakerCard.appendChild(imgWrap);
        speakerCard.appendChild(name);
        if (organization) speakerCard.appendChild(organization);
