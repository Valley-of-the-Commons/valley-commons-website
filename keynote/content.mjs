  ...
  "w2-d5": {
    ...
    meta: {
      ...
      socials: [
        ...
        { label: "FarmLab", url: "https://www.fablabs.io/labs/farmlab" },
      ],
      metaTitle: "International FabLab Networks \xb7 Silvia Brandi",
      metaDescription:
        "Companion to Silvia Brandi's talk on international FabLab networks at Valley of the Commons: the argument in beats and the live session.",
    },
    items: [
      {
        type: "quiz",
        prompt: "In the Fab City framework, what does 'PITO to DIDO' describe?",
        options: [
          "A change from analog to digital design tools",
          "From 'Product In, Trash Out' to 'Data In, Data Out'",
          "A funding model for municipal labs",
          "A ranking of the world's fabrication labs",
        ],
      },
      {
        type: "quiz",
        prompt: "By what year have Fab City-pledged cities committed to produce most of what they consume?",
        options: ["2030", "2040", "2054", "2100"],
      },
      {
        type: "quiz",
        prompt: "Which institution houses Fab Lab Barcelona and coordinates Fab City (where Brandi was General Manager)?",
        options: [
      ...
      {
        type: "quiz",
        prompt: "What makes a workshop part of the global Fab Lab network, not just a maker space?",
        options: [
          "It must be located in a major city",
          "It must be privately funded",
          "A shared inventory and open protocols, so any lab can reproduce another's work",
          "It must specialise in 3D printing",
        ],
      },
      {
        type: "quiz",
        prompt: "In Brandi's FarmLab, distributed digital fabrication is combined with what?",
        options: [
          "High-frequency financial trading",
          "Traditional crafts, local resources and seasonal rural cycles",
      ...
      {
        type: "poll",
        prompt: "Where are you on the make-vs-buy spectrum?",
        options: [
          "I buy almost everything ready-made",
          "I repair some things",
          "I make or repair a lot of what I use",
          "I make almost everything myself",
        ],
      },
      {
        type: "poll",
        prompt: "How close is a place to make things to where you live?",
        options: [
          "No access",
          "A makerspace / FabLab I could reach",
      ...
      {
        type: "poll",
        prompt: "For your community, which matters more right now?",
        options: [
          "Producing more locally",
          "Sharing knowledge and designs openly",
          "Both equally",
          "Neither is realistic yet",
        ],
      },
      {
        type: "poll",
        prompt: "The Fab City pledge, produce most of a city's consumption by 2054, reads to you as:",
        options: [
      ...
      {
        type: "poll",
        prompt: "Distributed fabrication feels more relevant to:",
        options: [
          "Mainly cities",
          "Mainly rural / regenerative contexts",
          "Both equally",
          "Neither",
        ],
      },
    ...
    beats: [
      {
        n: 1,
        title: "From workshop to network",
        body: "A FabLab is not just a room full of machines: it is one node in a global, standardised network. The rule that any lab can rebuild any other lab's project is what turns thousands of local workshops into a single shared capability.",
        links: [],
      },
      {
        n: 2,
        title: "PITO to DIDO",
        body: "Today's cities import products and export trash (Product In, Trash Out). The Fab City wager flips this: let data and design move around the world, and keep materials and making local (Data In, Data Out).",
        links: [],
      },
      {
        n: 3,
        title: "The Fab City pledge",
        body: "Barcelona-born, now dozens of cities and regions have committed to produce most of what they consume by 2054, a concrete target that reframes FabLabs as infrastructure, not hobby spaces.",
        links: [],
      },
      {
        n: 4,
        title: "How the network actually works",
        body: "A shared inventory, the Fab Academy, an open directory, and common protocols: the connective tissue that lets a lab in Barcelona, Boston or Bhutan collaborate as peers.",
        links: [],
      },
      {
        n: 5,
        title: "Distributed design in practice",
        body: "Local production plus global knowledge-sharing, turning circular-economy theory into working city pilots.",
        links: [],
      },
      {
        n: 6,
        title: "From city to countryside",
        body: "Her FarmLab turn: the same distributed-fabrication logic applied to rural life, craft traditions, local materials, and seasonal cycles, arguing the network model is regenerative and bioregional, not only urban.",
        links: [{ label: "FarmLab", url: "https://www.farmlab.at/team" }],
      },
      {
        n: 7,
        title: "What a commons gathering can do with this",
        body: "FabLabs as commons infrastructure: open, replicable, locally owned, and what it takes to plug a new node into the international network.",
        links: [
          { label: "Atlas of the Future", url: "https://atlasofthefuture.org/" },
        ],
      },
    ],
    cta: { label: "Valley of the Commons", url: "/keynote" },
